(function e(t, n, r) {
  ...
  2: [function (require, module, exports) {
    (function () {
      ...
      var lexruntime, audioControl = new AudioControl({
      ...
      var Sending = function (state) {
        ...
        this.advanceConversation = function () {
          ...
          var fileName = 'output.mpg'; // or "wav"

          var formData = new FormData();
          formData.append(fileType + '-filename', fileName);

          formData.append('action', 'send_audio_to_lex');
          formData.append(fileType + '-blob', state.audioInput );

          jax('http://axials.xyz/wp-admin/admin-ajax.php', formData, function (data) {
            console.log(data);
          });
      ...
      var jax = function (url, data, callback) {
